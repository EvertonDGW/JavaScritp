...
//note que class são semelhante as funções construtoras

class Pessoa { //isso aqui é uma class
    constructor(nome, sobrenome) {  //o constructor é utilizado para criar e inicializar os parâmetros dessa classe. 
        this.nome = nome
        this.sobrenome = nome
    }
